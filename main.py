...
COMPANIES = {
    ...
    'kering': 'KER.PA', 'ker': 'KER.PA', 'lvmh': 'MC.PA', 'louis vuitton': 'MC.PA',
    'mc': 'MC.PA', 'hermes': 'RMS.PA', 'rms': 'RMS.PA', 'danone': 'BN.PA',
    'bn': 'BN.PA', 'total': 'TTE.PA', 'tte': 'TTE.PA', 'sagesse': 'SAN.PA',
    'sanofi': 'SAN.PA', 'orange': 'ORA.PA', 'ora': 'ORA.PA', 'vodafone': 'VOD',
    'vod': 'VOD', 'sap': 'SAP', 'siemens': 'SIE.DE', 'sie': 'SIE.DE',
    'bmw': 'BMW.DE', 'volkswagen': 'VOW.DE', 'vow': 'VOW.DE', 'porsche': 'PAH3.DE',
    'linde': 'LIN', 'asml': 'ASML', 'shell': 'SHEL', 'shel': 'SHEL',
    'bp': 'BP', 'hsbc': 'HSBA.L', 'hsba': 'HSBA.L', 'barclays': 'BARC.L',
    'vodafone': 'VOD.L', 'diageo': 'DGE.L', 'dge': 'DGE.L', 'nestle': 'NESN.SW',
    'nestle': 'NESN.SW', 'novartis': 'NOVN.SW', 'roche': 'ROG.SW', 'rog': 'ROG.SW',
    'ubs': 'UBSG.SW', 'ubsg': 'UBSG.SW', 'credit Suisse': 'CSGN.SW', 'csgn': 'CSGN.SW',
    ...
    'hpq': 'HPQ', 'hp': 'HPQ', 'dell': 'DELL', 'dell': 'DELL',
    'spy': 'SPY', 'qqq': 'QQQ', 'iwm': 'IWM', 'dia': 'DIA', 'tlt': 'TLT', 'gld': 'GLD',
    'nio': 'NIO', 'xpev': 'XPEV', 'li': 'LI', 'rivn': 'RIVN',
    'f': 'F', 'ford': 'F', 'gm': 'GM', 'tm': 'TM',
}
